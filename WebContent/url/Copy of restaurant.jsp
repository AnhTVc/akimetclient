								...
								<div class="row">
									...
									Nếu đã có đánh giá cho nhà hàng thì tính trung bình -->
										<div
											...
											<div>
												<span class="avg-txt-highlight">8.2</span>
											</div>
											<div
											...
											<div class="row">
												<div class="form-group">
													<div style="margin-bottom: 25px" class="input-group">
														<span class="input-group-addon"><i class="fa fa-pencil" aria-hidden="true"></i></span> <input
															id="title_comment" type="text" class="form-control"
															name="title_comment" value="" placeholder="Nhập tiêu đề, ví dụ: Món ăn ở đây rất tuyệt" require>
													</div>
												</div>
												<div class="form-group">
				...
				<!-- <div>
					<div
						...
						<div class="row">
							...
							<div class="col-md-2">
								<p
									style="text-transform: capitalize; text-overflow: ellipsis; font-weight: 700;">Anh
									Trần</p>
								<span style="font-size: 11px; color: #666;"
									title="22/11/2016 22:5">22/11/2016 22:5p</span>
							</div>
						...
						<div style="line-height: 25px;">
							<h4
								style="color: #333; padding: 8px 0; font-size: 14px; font-weight: 700;">Thu
								Hương Bakery</h4>
							<p
								style="white-space: pre-line; font-size: 14px; line-height: 1.4em;">Vị
								trí: mặt đường Giảng Võ, mặt tiền to nên dễ thấy. Decor: không
								gian rộng, bên ngoài bán bánh, bên trong làm bánh. Ngoài ra thì
								không có gì đặc biệt. Chỗ để xe rộng.</p>
						</div>
						Image
						<div class="row">
							<div class="col-md-2" style="margin-left: 5px">
								<img alt=""
									src="https://media.foody.vn/res/g1/5905/s160x160/foody-thu-huong-bakery-giang-vo-334-636152817581798118.jpg">
							</div>
							<div class="col-md-2" style="margin-left: 5px">
								<img alt=""
									src="https://media.foody.vn/res/g1/5905/s160x160/foody-thu-huong-bakery-giang-vo-568-636152817566768154.jpg">
							</div>
							<div class="col-md-2" style="margin-left: 5px">
								<img alt=""
									src="https://media.foody.vn/res/g1/5905/s160x160/foody-thu-huong-bakery-giang-vo-334-636152817581798118.jpg">
								...
								<div class="modal-content" style="border-radius: 0">
									...
									<div class="modal-footer">
										<div class="row">
											...
											<div class="col-sm-4">
												<button type="submit" class="btn btn-default my-button "
